...
//         productName: 'absorgelmax&Compact',
...
const ProductPage = () => {
    return <>
        ...
        <div className='md:flex max-w-screen flex-wrap gap-10'>
            {products.map(product => <ProductCard key={product.id} id={product.id} thumb={product.thumb} title={product.title} description={product.description} categoryId={product.categoryId}/>)}
        </div>
    </>
}
